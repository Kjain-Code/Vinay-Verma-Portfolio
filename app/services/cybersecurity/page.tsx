...
export const metadata: Metadata = {
  title: "Cybersecurity Services | TechSpire Solutions - Vinay Verma",
  description:
    "Professional cybersecurity services including penetration testing, security audits, and vulnerability assessments. Protecting businesses in India, USA, UK, Canada, and Australia.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Expert cybersecurity: penetration testing, audits, and security implementation. Serving clients globally.",
    type: "website",
  },
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground">
                ...
                have the skills and experience to enhance your organization's security posture. Serving clients in
                India, USA, UK, Canada, Australia, and globally.
              </p>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-xl transition-all duration-500 border border-primary/10 hover:border-primary/30 relative overflow-hidden">
              ...
              <CardFooter>
                <Button asChild className="w-full bg-primary hover:bg-primary/90 transition-all duration-300">
                  <a href="https://wa.me/916392493623?text=I'm%20interested%20in%20the%20Basic%20Security%20Audit%20package" target="_blank" rel="noopener noreferrer">
                    Get Started
                  </a>
                </Button>
              </CardFooter>
            ...
            <Card className="group hover:shadow-xl transition-all duration-500 border-2 border-primary/30 hover:border-primary/50 relative overflow-hidden scale-105">
              ...
              <CardFooter>
                <Button asChild className="w-full bg-primary hover:bg-primary/90 transition-all duration-300">
                  <a href="https://wa.me/916392493623?text=I'm%20interested%20in%20the%20Comprehensive%20Security%20package" target="_blank" rel="noopener noreferrer">
                    Get Started
                  </a>
                </Button>
              </CardFooter>
            ...
            <Card className="group hover:shadow-xl transition-all duration-500 border border-primary/10 hover:border-primary/30 relative overflow-hidden">
              ...
              <CardHeader className="pt-10">
                ...
                <CardDescription className="mt-4">Advanced security for complex applications and e-commerce</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  {[
                    ...
                    "6 months of security monitoring",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-2">
                      <Check className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                      <span className="text-muted-foreground">{item}</span>
              ...
              <CardFooter>
                <Button asChild className="w-full bg-primary hover:bg-primary/90 transition-all duration-300">
                  <a href="https://wa.me/916392493623?text=I'm%20interested%20in%20the%20Enterprise%20Security%20package" target="_blank" rel="noopener noreferrer">
                    Get Started
                  </a>
                </Button>
              </CardFooter>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { initials: "VP", name: "Vikram Patel", location: "Bangalore, India", text: "Vinay conducted a thorough security audit of our e-commerce platform and identified several critical vulnerabilities that we were unaware of. His detailed report and implementation guidance helped us secure our platform effectively. Highly recommended!" },
              { initials: "MJ", name: "Michael Johnson", location: "London, UK", text: "After experiencing a security breach, we hired Vinay to assess our systems and implement better security measures. His expertise in cybersecurity is impressive, and he provided practical solutions that were easy to implement. Our systems are now much more secure." },
              { initials: "SS", name: "Sanjay Sharma", location: "Delhi, India", text: "Vinay's penetration testing service was eye-opening. He found vulnerabilities in our web application that our internal team had missed. His approach is methodical and his explanations are clear, making it easy for us to understand and address the issues." },
              { initials: "AR", name: "Amanda Rodriguez", location: "Toronto, Canada", text: "We engaged Vinay for a security audit of our financial application. His attention to detail and thorough approach uncovered several potential security risks. The remediation plan he provided was clear and actionable. We now feel much more confident about our application's security." },
            ].map((t) => (
