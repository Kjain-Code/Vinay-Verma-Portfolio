          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button asChild size="lg" className="group bg-primary hover:bg-primary/90 transition-all duration-300 rounded-full shadow-md hover:shadow-lg">
                  <Link href="/contact">
                    Get a Quote
                    <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="border-primary/20 hover:border-primary/50 transition-all duration-300 rounded-full">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg border border-primary/10">
              {service.heroImage ? (
                ...
                <img src={service.heroImage} alt={service.title} className="w-full h-auto object-cover" />
              ) : (
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/50">
                ...
                <CardContent>
                  <p className="text-muted-foreground text-sm">
                    Professional {feature.toLowerCase()} services tailored to your specific business needs and requirements.
                  </p>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {service.plans.map((plan) => (
              ...
              >
                ...
                <CardFooter>
                  <Button asChild className="w-full bg-primary hover:bg-primary/90 transition-all duration-300 rounded-full">
                    <a
                      href={`https://wa.me/${WA_NUMBER}?text=I'm%20interested%20in%20the%20${encodeURIComponent(plan.name)}%20package`}
                      target="_blank"
          ...
          <div className="max-w-3xl mx-auto">
            <Tabs defaultValue="all" className="w-full">
              <TabsList className="grid w-full grid-cols-1 mb-8">
                <TabsTrigger value="all" className="text-base py-3">All Questions</TabsTrigger>
              </TabsList>
      ...
      <section className="py-12">
        <div className="container">
          <div className="text-center space-y-4 max-w-3xl mx-auto mb-12">
            ...
            <div className="w-20 h-1 bg-primary mx-auto"></div>
            <p className="text-muted-foreground">What our clients say about our {service.title.toLowerCase()} services</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { initials: "RK", name: "Rahul Kumar", location: "Delhi, India" },
              { initials: "JS", name: "John Smith", location: "New York, USA" },
            ].map((t) => (
              <Card key={t.name} className="group hover:shadow-lg transition-all duration-300 border border-primary/10 hover:border-primary/30">
                ...
                <CardContent>
                  ...
                  <p className="text-muted-foreground">
                    "The {service.title.toLowerCase()} services provided by Vinay exceeded all my expectations. The attention to detail and technical expertise are impressive. I highly recommend these services to anyone looking for professional solutions."
                  </p>
                </CardContent>
              </Card>
            ))}
      ...
      <section className="py-16">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-6 bg-primary/5 p-8 rounded-lg border border-primary/20">
            ...
            <p className="text-muted-foreground">
              Contact me today to discuss your {service.title.toLowerCase()} requirements and how I can help you achieve your goals.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 transition-all duration-300 rounded-full">
